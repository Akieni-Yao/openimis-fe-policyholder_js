...
import UnlockPolicyHolderForm from "../components/UnlockPolicyHolderForm";

const styles = (theme) => ({
  page: theme.page,
});

class UnlockPolicyHolderPage extends Component {
  constructor(props) {
    super(props);
...
export default withHistory(
  withModulesManager(
    injectIntl(
      withTheme(
        withStyles(styles)(
          connect(mapStateToProps, mapDispatchToProps)(UnlockPolicyHolderPage)
        )
      )
    )
  )
