...
import PaymentForApprovalDetails from "../components/PaymentForApprovalDetails";
...
class PaymentForApproval extends Component {
  state = {
    reset: 0,
  };
...
export default injectIntl(
  withTheme(
    withStyles(styles)(
      connect(mapStateToProps, mapDispatchToProps)(PaymentForApproval)
    )
  )
);
