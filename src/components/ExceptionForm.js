      ...
      <Fragment>
        <Helmet
          title={formatMessageWithValues(
            this.props.intl,
            "policyHolder",
            "exception.exceptionInsuree.label",
            this.titleParams()
          )}
        />
        <Form
          module="policyHolder"
          title="exception.exceptionInsuree.label"
          ...
          HeadPanel={ExceptionMasterPanel}
...
export default withHistory(
  withModulesManager(
    injectIntl(
      withTheme(
        withStyles(styles)(
          connect(mapStateToProps, mapDispatchToProps)(ExceptionForm)
        )
      )
    )
  )
